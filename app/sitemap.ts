...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: 'https://www.ki-gastronomie.com/ai-readiness-report-2026', lastModified: new Date(), changeFrequency: 'weekly', priority: 0.9 },
    ...['berlin','hamburg','muenchen','koeln','frankfurt','stuttgart','duesseldorf','leipzig','dortmund','mannheim'].map(city => ({
      url: `https://www.ki-gastronomie.com/${city}-ki-studie-2026`,
      lastModified: new Date(),
      changeFrequency: 'weekly' as const,
      priority: 0.8,
    })),
