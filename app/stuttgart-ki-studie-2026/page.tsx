...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: "de_DE",
    type: "article",
    url: "https://www.ki-gastronomie.com/stuttgart-ki-studie-2026",
  ...
  alternates: {
    canonical: "https://www.ki-gastronomie.com/stuttgart-ki-studie-2026",
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntityOfPage": {
              "@type": "WebPage",
              "@id": "https://www.ki-gastronomie.com/stuttgart-ki-studie-2026"
            },
            "isPartOf": {
              "@type": "Article",
