    ...
    <>
      ...
      >
        <div className="relative max-w-4xl">
          ...
          >
            1.000 Restaurants · 10 Städte · 4.000 Scans · März 2026
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            },
            {
              ...
              text: "59,1% der Restaurants mit 4,5+ Google-Sternen sind für KI-Suchmaschinen nicht auffindbar. r = \u22120,04.",
              color: "#FF1744",
            },
          ].map((card, i) => (
            <div
          ...
          {[
            {
              ...
              desc: "Misst 8 On-Page-Kriterien: Antwortstruktur, Schema Markup, FAQ-Aufbau, Metadaten, Lesbarkeit, Autor-Signal, Aktualität, externe Quellen.",
              color: "#6366f1",
            },
            {
              name: "KI-Zitierbarkeits-Scanner",
              question: "Kennt ChatGPT&Co deinen Ruf als Restaurant?",
              desc: "Misst 5 Zitierbarkeits-Dimensionen: Schema Markup, Content-Struktur, Statistiken & Fakten, E-E-A-T Signale, Technische Crawlbarkeit.",
              color: "#A8E6A3",
            },
            {
              name: "KI-Agent-Readiness-Scanner",
              question: "Können Gäste via KI-Agenten einen Tisch reservieren oder dein Restaurant finden?",
              desc: "Misst 5 Infrastruktur-Dimensionen: Zugang für KI-Bots, Parsability, Entity-Vertrauen, Auffindbarkeit (sitemap/llms.txt), Interaktivität.",
              color: "#FFE600",
            },
            {
              name: "KI-Sicherheits-Scanner",
              question: "Wie angreifbar ist dein Restaurant für KI-gestützte Angriffe?",
              desc: "Misst 5 Sicherheits-Dimensionen: Datenprofil-Exposition, Deepfake-Risiko, KI-Einfallstore, Manipulationsfläche, Agent-Angriffsfläche.",
              color: "#FF1744",
            },
          ].map((scanner, i) => (
            <div
        ...
        <div className="space-y-3 mb-8">
          {[
            ...
            <div
              ...
              style={{ background: "rgba(255,255,255,0.03)" }}
            >
              <div className="w-1 flex-shrink-0" style={{ background: "#FF3CAC" }} />
      ...
      <section className="relative py-24 px-6 max-w-5xl mx-auto" style={{ zIndex: 1 }}>
        ...
        <p className="text-sm leading-relaxed mb-8 max-w-3xl" style={{ color: "#cccccc" }}>
          Das Ergebnis ist eindeutig: Bei über der Hälfte (52%) fehlt KI-Agenten die Infrastruktur um zu handeln. Bei den restlichen 48,0% ist zwar eine Grundlage vorhanden — aber kein einziges Restaurant ist wirklich &apos;agent-ready&apos;. Die Nutzbarkeits-Lücke wächst mit jedem neuen Gastro KI-Agenten der in den Markt kommt.
        </p>
      ...
      <section className="relative py-24 px-6 max-w-5xl mx-auto" style={{ zIndex: 1 }}>
        ...
        >
          <p className="text-base font-semibold" style={{ color: "#F59E0B" }}>
            591 Restaurants (59,1%) haben 4,5+ Google-Sterne — sind aber für KI-Suchmaschinen nicht auffindbar (AEO-Score unter 60).
          </p>
        </div>
        <p className="text-sm leading-relaxed mb-8 max-w-3xl" style={{ color: "#cccccc" }}>
